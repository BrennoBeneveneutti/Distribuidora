...
// 3. deu certo
	...
	private void listar() {
		java.util.List<Estudante> lista = this.bd.listarTodos();
		if (lista.isEmpty()) {
			this.view.mostrarMensagem("Nenhum cadastro encontrado.");
			return;
		}
		StringBuilder sb = new StringBuilder();
		for (Estudante e : lista) {
			sb.append("Nome: ").append(e.getNome())
			  .append(" | Matricula: ").append(e.getMatricula())
			  .append(" | Telefone: ").append(e.getTelefone())
			  .append("\n");
		}
		this.view.mostrarMensagem(sb.toString());
	}
